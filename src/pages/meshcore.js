      ...
      <main className="meshcore">
        ...
        <section id="map-section" className="map-section">
          <div className="container">
            ...
            <a href="https://analyzer.letsme.sh/map?lat=42.3601&long=-71.0589&zoom=10" target="_blank" rel="noopener noreferrer"><img src="/img/static-letsmesh-12-03-25.png" alt="BostonMesh Network Coverage Map" style={{ width: "100%", height: "auto", border: 0 }} /></a>
          </div>
        </section>
